...
def run_antenna_frequency():
    ...
    output_dir    = 'outputs/caez5g/ORU0/window50_sqasd/'
    ...
    # Load CFR window data from shards (CFR only — H representation)
    ...
    # Run
    run_config(
        'Antenna-Frequency H (CFR, ORU0, window50-SqASD)',
        H_win,
        'metrics_H_antenna_freq_CFR_273sc_4ant_ORU0_window50_sqasd.npz',
...
def run_antenna_delay():
    ...
    run_config(
        'Antenna-Delay C (CIR 68taps, ORU0, window50-SqASD)',
        C_cir_win,
        'metrics_C_antenna_delay_CIR_68taps_4ant_ORU0_window50_sqasd.npz',
...
def run_beam_delay():
    ...
    run_config(
        'Beam-Delay C_beam (CIR 68taps, ORU0, window50-SqASD)',
        C_beam_cir_win,
        'metrics_Cbeam_beam_delay_CIR_68taps_4beam_ORU0_window50_sqasd.npz',
        [('row', 'delay_per_beam')]
    )
    print("\nAll done!")
