...
output_dir    = 'outputs/caez5g/ORU0/window50_l11_l12/'
...
N_DMRS     = 3
K          = N_DMRS * N_WINDOW   # 150 slots per outer slice (flat pool)
...
configs = [
    (
        'Antenna-Frequency H (CFR, ORU0, window50-L11-L12)',
        H_win,
        'metrics_H_antenna_freq_CFR_273sc_4ant_ORU0_window50_l11_l12.npz',
        [('col', 'antenna_per_freq')]
    ),
    (
        'Antenna-Delay C (CIR 68taps, ORU0, window50-L11-L12)',
        C_cir_win,
        'metrics_C_antenna_delay_CIR_68taps_4ant_ORU0_window50_l11_l12.npz',
        [('row', 'delay_per_antenna'), ('col', 'antenna_per_delay')]
    ),
    (
        'Beam-Delay C_beam (CIR 68taps, ORU0, window50-L11-L12)',
        C_beam_cir_win,
        'metrics_Cbeam_beam_delay_CIR_68taps_4beam_ORU0_window50_l11_l12.npz',
        [('row', 'delay_per_beam')]
    ),
]
