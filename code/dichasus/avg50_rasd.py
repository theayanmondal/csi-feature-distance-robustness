...
def run_antenna_frequency():
    ...
    OUTPUT_DIR = (
        "outputs/dichasus/"
        "ArrayA/average_over_50_sqasd_complex_antenna_per_frequency/"
    )
    ...
    # Complex SqASD for Antenna-per-Frequency over 50 temporal samples
    def compute_sqasd_antenna_per_frequency(
        cfr_window,
        distance_type,
    ):
        """Compute RASD for the antenna-per-frequency representation."""
    ...
    for (
        ...
        D_CHANNEL = (
            compute_sqasd_antenna_per_frequency(
                CFR_WINDOW,
                distance_type,
            )
        )
    ...
    print(
        ...
        "average over 50 samples (anchor + 49), SqASD"
    )
...
def run_delay_domain_features():
    ...
    OUTPUT_DIR = (
        "outputs/dichasus/"
        "ArrayA/average_over_50_sqasd_complex_cir_features_18taps/"
    )
    os.makedirs(OUTPUT_DIR, exist_ok=True)
    ...
    # SqASD over the 50 corresponding temporal samples
