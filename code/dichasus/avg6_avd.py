...
OUTPUT_DIR = (
    "outputs/dichasus/"
    "ArrayA/average_over_6_avd_18taps/"
)
...
# AVD over the six corresponding temporal samples
...
CONFIGURATIONS = [
    (
        ...
        "(complex CFR, Array A, average over 6)",
        C_CFR_FEAT,
        "col",
    ...
    (
        "Antenna-per-Delay "
        "(complex CIR, Array A, fixed 18 taps, average over 6)",
        C_CIR_FEAT,
        "col",
        "antenna_per_delay",
    ),
    ...
    (
        "Delay-per-Beam "
        "(complex 2D beam-CIR, Array A, fixed 18 taps, average over 6)",
        C_BEAM_CIR_FEAT,
        "row",
        "delay_per_beam",
    ),
